  ...
  return (
    <section className={styles.sectionTest}>
      ...
      <div style={{ padding: '2rem', fontWeight: 'bold' }}>
        ...
        <p className={styles.iphoneP375}>$iphoneP375</p>
        ...
        <p className={styles.ipadProP834}>$ipadProP834</p>
        <p className={styles.ipadL1024}>$ipadL1024</p>
        <p className={styles.ipadProL1112}>$ipadProL1112</p>
        <p className={styles.ipadProL1366}>$ipadProL1366</p>
